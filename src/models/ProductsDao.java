...
public class ProductsDao {
    ...
    public boolean updateProductQuery(Products product) {
        ...
        try {
            ...
            JOptionPane.showInternalMessageDialog(null, "error updating product data");
            return false;
        }
    }
    ...
    public boolean deleteProductQuery(int id) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "You cannot delete a product that has a relationship with another table");
            return false;
        }
    }
