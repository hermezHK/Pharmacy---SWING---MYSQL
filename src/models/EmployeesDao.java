...
public class EmployeesDao {
    ...
    //variables to send data between interface
    ...
    public boolean registerEmployeeQuery(Employees employee) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "error when registering employee" + e);
            return false;
        }
    }
    ...
    public boolean updateEmployeePassword(Employees employee){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "something happened while changing the password " + e);
            return false;
        }
    }
}   
